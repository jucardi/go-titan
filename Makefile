...
format:
	...
	@echo "  > getting goimports" && GOM111MODULE=off go get golang.org/x/tools/cmd/goimports
	@echo "  > getting goimports-blank-rm" && GOM111MODULE=off go get github.com/jucardi/goimports-blank-rm
