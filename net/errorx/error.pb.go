...
type Error struct {
	...
	Inner []*InnerError `protobuf:"bytes,5,rep,name=inner,proto3" json:"inner,omitempty"`
...
func (x *Error) GetInner() []*InnerError {
	if x != nil {
		return x.Inner
	}
	return nil
...
func (x *InnerError) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *InnerError) GetDetails() string {
	if x != nil {
		return x.Details
	}
	return ""
...
func (x *InnerError) GetCaller() string {
	if x != nil {
		return x.Caller
	}
	return ""
...
var file_error_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x6f, 0x72, 0x78, 0x22, 0x97, 0x02, 0x0a, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12,
	...
	0x65, 0x12, 0x28, 0x0a, 0x05, 0x69, 0x6e, 0x6e, 0x65, 0x72, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x12, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x78, 0x2e, 0x49, 0x6e, 0x6e, 0x65, 0x72, 0x45,
	0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x69, 0x6e, 0x6e, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x74,
	0x72, 0x61, 0x63, 0x65, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x74, 0x72, 0x61, 0x63,
	0x65, 0x12, 0x31, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x19, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x78, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72,
	...
	0x54, 0x0a, 0x0a, 0x49, 0x6e, 0x6e, 0x65, 0x72, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x14, 0x0a,
...
var file_error_proto_goTypes = []interface{}{
	...
	(*InnerError)(nil), // 1: errorx.InnerError
	nil,                // 2: errorx.Error.FieldsEntry
}
var file_error_proto_depIdxs = []int32{
	1, // 0: errorx.Error.inner:type_name -> errorx.InnerError
